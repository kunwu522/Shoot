...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.shootControl = [[ShootControl alloc] initWithFrame:CGRectMake(0, self.tags.frame.origin.y + self.tags.frame.size.height + PADDING, self.frame.size.width, [ShootControl getMinimalHeight]) isSimpleMode:TRUE];
